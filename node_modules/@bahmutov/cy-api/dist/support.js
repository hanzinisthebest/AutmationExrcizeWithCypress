...
Cypress.Commands.add('api', function (options, name) {
    ...
    cy.request(__assign(__assign({}, options), { log: false }))
        .then(function (_a) {
                ...
                if (displayRequest) {
                    ...
                    container.innerHTML +=
                        '\n<pre class="cy-api-logs-messages">' +
                            messages
                                .map(function (m) {
                                return "<div class=\"".concat(normalize(m.type), " ").concat(normalize(m.type, m.namespace), "\">").concat(m.type, " ").concat(m.namespace, ": ").concat(m.message, "</div>");
                            })
                                .join('') +
                            '\n</pre></div>';
                }
...
var getContainer = function () {
    ...
    if (!container) {
        ...
        // in Cypress v12
        var innerContainer = doc.querySelector('.inner-container');
        if (innerContainer) {
...
var formatJSon = function (jsonObject) {
    return highlight_js_1.default.highlight(JSON.stringify(jsonObject, null, 4), {
        language: 'json',
    }).value;
};
